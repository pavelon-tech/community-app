(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportUsersController: function (scope, http, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.download = function () {
                http({
                    ...
                    linkElement.setAttribute('download', 'USERS' + today + '.xls');
    ...
    mifosX.ng.application.controller('BulkImportUsersController', ['$scope', '$http', 'ResourceFactory', '$location', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.BulkImportUsersController]).run(function ($log) {
